...
public class RingNewsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        OKhttpManager.getInstance().asyncJsonStringByURL(ringNewsUrl, new OKhttpManager.Func1() {
            @Override
            public String onResponse(String result) {
                ...
                if (mediaPlayer != null) {
                    adapter = new RingNewsRecyclerViewAdapter(mRingrAdsList, list, getActivity(), imageList, flagList, mediaPlayer, isplayingList, downLoadFlag);
    ...
    private void initView(View itemView) {
        ...
        ringNewsUrl = RingBaseUrl + "/ringtones/new.php?loc=zh";
    ...
    private void setRingFeedNativeAds() {
        nativeAd = new NativeAdsManager(getActivity(), FacebookAdManager.RingsNewFeed_07, 5);
