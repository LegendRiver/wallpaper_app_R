...
import eli.tech.wallri.Adapter.Rings.RingContentHomePageRecyclerViewAdapter;
...
public class RingClassifyContentHomePageFragment extends Fragment {
    ...
    private RingContentHomePageRecyclerViewAdapter adapter;
    private int n = 20;
    private int s = 0;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        OKhttpManager.getInstance().asyncJsonStringByURL(ratingUrl, new OKhttpManager.Func1() {
            ...
            public String onResponse(String result) {
                ...
                adapter = new RingContentHomePageRecyclerViewAdapter(mRingrAdsList, imageList, list, getActivity(), flagList, mediaPlayer, isplayingList, downLoadFlag);
                mNewsRecyclerViewRing.setAdapter(adapter);
                setRingFeedNativeAds();
                nativeAd.loadAds();
                //条目点击事件
                adapter.setOnItemClickListener(new RingContentHomePageRecyclerViewAdapter.onItemClickListener() {
                    @Override
                ...
                mNewsRefreshRing.setOnRefreshListener(new RefreshListenerAdapter() {
                    ...
                    public void onLoadMore(TwinklingRefreshLayout refreshLayout) {
                        ...
                        n = n + 20;
                        s = s + 20;
                        String mLoadMoreUrl = "http://rington.co/android/picyap-rw/ringtones/list.php?v=" + category_name + "&loc=zh&s=" + s + "&n=" + n + "&sort=downloads";
    ...
    public void onMoonEvent(MessageEvent messageEvent) {
        try {
            ...
            if (messageEvent.getMessage() == 408) {
                EventBus.getDefault().post(new MessageEvent(401));
    ...
    private void initView(View itemView) {
        ...
        ratingUrl = "http://rington.co/android/picyap-rw/ringtones/list.php?v=" + category_name + "&loc=zh&s=" + s + "&n=" + n + "&sort=downloads";
    ...
    private void setRingFeedNativeAds() {
        nativeAd = new NativeAdsManager(getActivity(), FacebookAdManager.RingCategoryPopular_09, 5);
