...
public class RingNewsRecyclerViewAdapter extends RecyclerView.Adapter {
    ...
    private Map<Integer, NativeAd> RingsObjectList;
    ...
    public RingNewsRecyclerViewAdapter(  Map<Integer, NativeAd> RingsObjectList, List<RingNewsbean.RingtonesBean> list, Context context, List<ProgressBean> imageList, List<Integer> flagList, MediaPlayer mediaPlayer, List<Boolean> isplayingList, List<Integer> downLoadFlag) {
        this.list = list;
        ...
        this.RingsObjectList = RingsObjectList;
    }
        ...
        if (itemType == 0) {
            ...
            myViewHolder.mRing_Homepage_Image.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(final View v) {
                    EventBus.getDefault().post(new MessageEvent(3300));
                    if (nameList.size() != 0) {
                        ...
                        if (!file.exists()) {
                            ...
                            try {
                                mediaPlayer.setDataSource(Environment.getExternalStorageDirectory()
                                        ...
                                        + list.get(position).getTitle() + ".mp3");
            ...
            NativeAd nativeAd = RingsObjectList.get(position);
            try {
