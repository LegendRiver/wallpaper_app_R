...
public class RingContentHomePageRecyclerViewAdapter extends RecyclerView.Adapter {
    ...
    public RingContentHomePageRecyclerViewAdapter(Map<Integer, NativeAd> mRingrAdsList, List<ProgressBean> imageList, List<RingNewsbean.RingtonesBean> list, Context context, List<Integer> flagList, MediaPlayer mediaPlayer, List<Boolean> isplayingList, List<Integer> downLoadFlag) {
        ...
        if (itemType == 0) {
            ...
            myViewHolder.mRing_Homepage_Image.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(final View v) {
                    EventBus.getDefault().post(new MessageEvent(2220));
                    if (nameList.size() != 0) {
