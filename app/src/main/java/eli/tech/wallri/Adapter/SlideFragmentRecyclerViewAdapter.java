...
public class SlideFragmentRecyclerViewAdapter extends RecyclerView.Adapter {
    ...
    public SlideFragmentRecyclerViewAdapter(List<Integer> listImage, List<Integer> list, Context context) {
        this.list = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = LayoutInflater.from(context).inflate(R.layout.navifragmentitem, parent, false);
    ...
    public int getItemCount() {
     ...
     class myViewHolder extends RecyclerView.ViewHolder {
        ...
        public myViewHolder(View itemView) {
            super(itemView);
            mNvifragment_Text = itemView.findViewById(R.id.navifragment_Text);
            mNavifragment_Image = itemView.findViewById(R.id.navifragment_Image);
