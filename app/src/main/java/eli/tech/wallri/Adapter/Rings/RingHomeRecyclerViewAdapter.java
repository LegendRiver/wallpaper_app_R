...
public class RingHomeRecyclerViewAdapter extends RecyclerView.Adapter {
    ...
    public RingHomeRecyclerViewAdapter(Map<Integer, NativeAd> mRingrAdsList, List<RingNewsbean.RingtonesBean> list, Context context, List<ProgressBean> imageList, List<Integer> flagList, MediaPlayer mediaPlayer, List<Boolean> isplayingList, List<Integer> downLoadFlag) {
        this.list = list;
        ...
        if (itemType == 0) {
            ...
            myViewHolder.mRing_Homepage_Image.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(final View v) {
                    EventBus.getDefault().post(new MessageEvent(2200));
                    if (nameList.size() != 0) {
